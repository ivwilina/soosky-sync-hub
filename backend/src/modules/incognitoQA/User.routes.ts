...
export default class IncognitoQA_UserRoutes {
  ...
  public readonly routes = [
    ["GET", "/incognito-letter/letters/:id", this._GET_getAllPersonalLetters.bind(this)],
    ["GET", "/incognito-letter/letter/:id", this._GET_getALetter.bind(this)],
  ...
  private async _GET_getAllPersonalLetters(req: Request, res: Response): Promise<any> {
